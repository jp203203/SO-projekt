...
public:
    TabuSearch();
    std::pair<std::vector<int>, int> findTabuSolution(int** graph_matrix, int no_of_cities, int timeout_s, NeighborhoodMethod method, int tabu_limit, int diversify_point);
private:
